...
const NAV_ITEMS = ["Admin Home", "Materials", "Teachers", "Students", "IRT / Student analytics", "Measurement", "Practice Debug"] as const;
...
export default function AdminApp({ embedded = false, onExit, initialNav = "Admin Home" }: { embedded?: boolean; onExit?: () => void; initialNav?: AdminNav } = {}) {
  ...
  const heading = activeNav === "Materials" ? "Materials" : activeNav === "IRT / Student analytics" ? "IRT / Student analytics" : activeNav === "Measurement" ? "Measurement health" : activeNav === "Practice Debug" ? "Practice Stage Debugger" : "Account Control Center";
