...
const NAV_ITEMS = ["Admin Home", "Materials", "Vocabulary", "Teachers", "Students", "IRT / Student analytics", "Measurement", "Practice Debug", "ASR Compare", "BKT Debug", "Research"] as const;
