...
const NAV_ITEMS = ["Admin Home", "Materials", "Audio Library", "Vocabulary", "Teachers", "Students", "IRT / Student analytics", "Measurement", "Practice Debug", "ASR Compare", "BKT Debug", "Research", "Learning Engine"] as const;
