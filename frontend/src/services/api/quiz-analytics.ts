...
export interface VocabQuizAttempt { id: string; storyId: string; studentName: string; studentId?: string; mode?: "tier1" | "tier2" | "tier3" | "speed" | "strikes" | "free" | "weak_words" | "maintenance_review" | "challenge"; baseStoryId?: string; level?: string; completedAt: string; totalQuestions: number; correctCount: number; totalTimeMs: number; questionResults: Array<{ word: string; correct: boolean; timeMs: number; itemId?: string; conceptId?: string; questionKind?: string; round?: 1 | 2 | 3; tier?: "tier1" | "tier2" | "tier3"; knowledgeDimension?: "meaning" | "pinyin_production" | "contextual_recall"; activityType?: "diagnostic" | "personalized_practice" | "scheduled_maintenance" | "challenge" | "practice"; level?: string; baseStoryId?: string; itemVersion?: string; selectedAnswer?: string; correctAnswer?: string; presentedOptions?: string[]; questionPrompt?: string; answeredAt?: string; questionIndex?: number; lessonId?: string; quizId?: string; isBktEligible?: boolean; bktEligibilityErrors?: string[]; diagnosticExposureId?: string; assistedResponse?: boolean; bktValidationStatus?: "APPROVED" | "DRAFT" }>; }
