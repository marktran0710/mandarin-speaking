...
export interface StoredAudioRecord { id: string; timestamp: string; duration: number; transcription: string; model: string; topicId?: string; studentId?: string | null; imageUrl?: string; imageIndex?: number; conversationId?: string; turnId?: string; turnIndex?: number; audioUrl?: string; audioName?: string; praatMetrics?: any; analysisVersion?: "stable_v1"; analysisSchemaVersion?: string; modelVersion?: string; comparisonGroupId?: string; sessionId?: string; attemptId?: string; attemptNumber?: number; attemptType?: "WHOLE_SENTENCE_INITIAL" | "FOCUSED_RETRY" | "WHOLE_SENTENCE_FINAL"; serverVerifiedAt?: string | null; audioSha256?: string | null; serverVerificationVersion?: string | null; }
export interface StoredSpeakingProgress { studentId: string; topicId: string; sceneIndex: number; attempts: number; bestTone: number; bestFluency: number; masteryPassed: boolean; contentPassed: boolean; clearedWords: string[]; conversationId?: string; turnId?: string; turnIndex?: number; latestResult?: SceneSubmission | null; baseStoryId?: string; difficultyLevel?: "easy" | "medium" | "hard"; promptId?: string; verifiedAudioRecordId?: string | null; progressionEligible?: boolean; }
