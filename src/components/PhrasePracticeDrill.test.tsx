...
describe("PhrasePracticeDrill", () => {
  it("shows one target phrase and explains the pitch comparison", () => {
    ...
    expect(screen.getByText("Say this part on its own. Every word must match its target pitch shape.")).toBeInTheDocument();
